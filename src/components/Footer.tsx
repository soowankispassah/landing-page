...
export default function Footer() {
  ...
  const handleNavigation = (e: React.MouseEvent<HTMLAnchorElement>, href: string) => {
    handleSectionNavigation(e, href, pathname, router)
  }
          ...
          <div className="space-y-4">
            ...
            <form className="space-y-2">
              <input
                ...
                className="w-full px-4 py-2 rounded-md bg-white border border-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-500"
              />
              <button
                type="submit"
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex items-center space-x-4">
              <a 
                ...
                className="font-bold text-xl hover:text-indigo-600 transition-colors"
              >
                OlenkaAI
              </a>
              <span className="text-gray-600">© 2024 OlenkaAI. All rights reserved.</span>
            </div>
